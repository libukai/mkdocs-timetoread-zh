...
class TimeToReadZh(BasePlugin):
    ...
    config_scheme = (
        ...
        (
            "textColor",
            config_options.Type(str, default="bdbdbd"),
        ),
        (
            "substitute",
            config_options.Type(str, default="</h1>"),
        ),
        (
            "template",
            config_options.Type(
        ...
        (
            "language",
            config_options.Type(str, default="zh"),
        ),
        (
            "min_time",
            config_options.Type(int, default=1),
        ),
        (
            "round_method",
            config_options.Type(str, default="ceil"),
        ),
    )
